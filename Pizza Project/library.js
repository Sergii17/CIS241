...
function orderSummary(){
	...
	// check to see which pizza is selected
	...
	switch(intType){
		case 0:
		  ...
		  break;
		case 1:
		  strPizza = strPizza + '<br />Hawaiian ';
		  fltSub = 11.95;
		  break;
		case 2:
		  strPizza = strPizza + '<br />Greek Pizza ';
		  fltSub = 10.95;
		  break;
		  case 3:
		  strPizza = strPizza + '<br />Own Pizza ';
		  fltSub = 8.5;
		  break;
	}
...
//		  fltSub += 10.95;
	...
	switch(intCrust){
		case 0:
		  strPizza = strPizza + " thin crust <br />";
		  break;
		case 1:
		  strPizza = strPizza + " pan crust <br />";
		  fltSub += 1.00;
		  break;
	}
...
for (var i = 0; i < document.forms[0].topping.length; i++){
if (document.forms[0].topping[i].checked){
intTopCount += 1;
strTopID = "topID" + i;
strPizza = strPizza + " &nbsp;&nbsp;&nbsp;&nbsp;" +
document.forms[0].topping[i].value + "<br />";
} 

}

fltSub = fltSub + (intTopCount * .75);
...
function writePizzaCookies(){
 ...
 //functions for checkboxes(show,hide,uncheck)
...
function uncheck(){
	...
	document.getElementById("gar").checked = false;
}
...
function chForm(){
	...
	if (!phoneExp.test(document.forms[0].txtPhone.value)){
		document.getElementById("txtPhone").innerHTML = "Please enter your phone number in format XXX-XXX-XXXX";
		document.forms[0].txtEmail.focus();
		document.forms[0].txtEmail.select();
		return false
	}
